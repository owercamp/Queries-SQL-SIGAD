...
Public Function validateConcepts(value)
  ...
  Select Case Trim$(UCase$(value))
   ...
   Case "PUEDE CONTINUAR LABORANDO", "PUEDE CONTINUAR REALIANZADO LA LABOR", "PUEDE CONTINUAR REALIZANDO LA  LABOR","PUEDE CONTINUAR REALIZANDO SU LABOR", "PUEDE CONTINUAR REALIZANDO LA LABORANDO", "PUEDE CONTINUAR DESEMPE" & Chr(209) & "ANDO SU LABOR","CON PATOLOGIA QUE NO LIMITA LA LABOR","PUEDE CONTINUAR REALIZANDO  LA LABOR","PUEDE CONTINUAR REALIZANDO AL LABOR"
    validateConcepts = Trim$("PUEDE CONTINUAR REALIZANDO LA LABOR")

    '' CONCEPTO DE EVALUACION: CUMPLE PARA DESEMPE"&Chr(209)&"AR EL CARGO ''
   Case "CUMPLE PARA DESEMPE" & Chr(209) & "AR EL CARGO", "APTO PARA DESEMPE" & Chr(209) & "AR CARGO", "CUMPLE PARA DESEMPE" & Chr(209) & "AR  CARGO","APTO PARA DESEMPE" & Chr(209) & "AR LABOR", "APTO PARA DESEMPE" & Chr(209) & "AR EL CARGO", "APTO PARA DESEMPE" & Chr(209) & "AR EL  CARGO","APTO (SIN PATOLOG" & Chr(205) & "AS EVIDENTES; CUMPLE CON LOS CRITERIOS M" & Chr(201) & "DICOS PARA EL CARGO)", "CUMPLE PARA REALIZAR EL CARGO", "APTO PARA EL CARGO SIN PATOLOGIA APARENTE","SE RECOMIENDA PARA EL CARGO SIN RESTRICCION"
