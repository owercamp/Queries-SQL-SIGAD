...
Public Function validateConcepts(value)
    ...
    Select Case Trim(UCase(value))
     ...
     Case "PUEDE CONTINUAR LABORANDO", "PUEDE CONTINUAR REALIANZADO LA LABOR", "PUEDE CONTINUAR REALIZANDO LA  LABOR","PUEDE CONTINUAR REALIZANDO SU LABOR", "PUEDE CONTINUAR REALIZANDO LA LABORANDO", "PUEDE CONTINUAR DESEMPE" & Chr(209) & "ANDO SU LABOR", "PUEDE CONTINUAR LABORANDO","CON PATOLOGIA QUE NO LIMITA LA LABOR"
        validateConcepts = Trim("PUEDE CONTINUAR REALIZANDO LA LABOR")

        '' CONCEPTO DE EVALUACION: CUMPLE PARA DESEMPE"&Chr(209)&"AR EL CARGO ''
     Case "CUMPLE PARA DESEMPE" & Chr(209) & "AR EL CARGO", "APTO PARA DESEMPE" & Chr(209) & "AR CARGO", "CUMPLE PARA DESEMPE" & Chr(209) & "AR  CARGO","APTO PARA DESEMPE" & Chr(209) & "AR LABOR", "APTO PARA DESEMPE" & Chr(209) & "AR EL CARGO", "APTO PARA DESEMPE" & Chr(209) & "AR EL  CARGO","APTO (SIN PATOLOG" & Chr(205) & "AS EVIDENTES; CUMPLE CON LOS CRITERIOS M" & Chr(201) & "DICOS PARA EL CARGO)", "CUMPLE PARA REALIZAR EL CARGO", "APTO PARA DESEMPE" & Chr(209) & "AR EL CARGO", "APTO PARA EL CARGO SIN PATOLOGIA APARENTE"
     ...
     Case "APTO CON RECOMENDACION", "APTO CON RESTRICCION", "CON PATOLOGIA QUE NO LIMITA LA LABOR","APTO CON DEFECTO F" & Chr(205) & "SICO O PATOLOGIA QUE NO LIMITA SU LABOR", "REINTEGRO CON RECOMENDACIONES","REINTEGRO CON MODIFICACIONES/RESTRICCIONES", "PRESENTA RESTRICCIONES", "REINTEGRO CON RESTRICCIONES","REINTEGRO CON RECOMENDACIONES", "APTO CON RESTRICCIONES", "APTO CON PATOLOG" & Chr(205) & "AS (QUE NO LIMITAN SU CAPACIDAD LABORAL)", "APTO CON RECOMENDACIONES", "EXAMEN PERIODICO CON RECOMENDACIONES","CUMPLE PARA DESEMPEÑAR EL CARGO CON RECOMENDACIONES","PUEDE CONTINUAR REALIZANDO LA LABOR CON RECOMENDACIONES"
