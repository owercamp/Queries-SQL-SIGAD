...
Public Function validateConcepts(value)
    ...
    Select Case Trim(UCase(value))
        ...
        Case "PUEDE CONTINUAR LABORANDO", "PUEDE CONTINUAR REALIANZADO LA LABOR", "PUEDE CONTINUAR REALIZANDO LA  LABOR", _
        "PUEDE CONTINUAR REALIZANDO SU LABOR", "PUEDE CONTINUAR REALIZANDO LA LABORANDO", "PUEDE CONTINUAR DESEMPE"&Chr(209)&"ANDO SU LABOR","PUEDE CONTINUAR LABORANDO"
            validateConcepts = Trim("PUEDE CONTINUAR REALIZANDO LA LABOR")
            
        '' CONCEPTO DE EVALUACION: CUMPLE PARA DESEMPE"&Chr(209)&"AR EL CARGO ''
        Case "CUMPLE PARA DESEMPE"&Chr(209)&"AR EL CARGO", "APTO PARA DESEMPE"&Chr(209)&"AR CARGO", "CUMPLE PARA DESEMPE"&Chr(209)&"AR  CARGO", _
        "APTO PARA DESEMPE"&Chr(209)&"AR LABOR", "APTO PARA DESEMPE"&Chr(209)&"AR EL CARGO", "APTO PARA DESEMPE"&Chr(209)&"AR EL  CARGO", _
        "APTO (SIN PATOLOG"&Chr(205)&"AS EVIDENTES; CUMPLE CON LOS CRITERIOS M"&Chr(201)&"DICOS PARA EL CARGO)", "CUMPLE PARA REALIZAR EL CARGO","APTO PARA DESEMPE"&Chr(209)&"AR EL CARGO","APTO PARA EL CARGO SIN PATOLOGIA APARENTE"
        ...
        Case "REASIGNACION DE TAREAS", "REASIGNACI"&Chr(211)&"N DE TAREAS", "REASIGNACI"&Chr(211)&"N DE FUNCIONES Y TAREAS", "REASIGNACI"&Chr(211)&"N", _
        "REASIGNACION"
            validateConcepts = Trim("REASIGNACION DE TAREAS")
            
        '' CONCEPTO DE EVALUACION: REINCORPORACION ''
        Case "REINCORPORACION", "REINCORPORACI"&Chr(211)&"N", "REINCORPORACI"&Chr(211)&"N AL PUESTO DE TRABAJO", _
        "REINTEGRO AL CARGO ACTUAL CON RECOMENDACIONES Y RESTRICCIONES", _
        "REINTEGRO TENIENDO EN CUENTA RECOMENDACIONES ESPECIFICAS", "REINCORPORACION AL PUESTO DE TRABAJO"
            validateConcepts = Trim("REINCORPORACION")
            
        '' CONCEPTO DE EVALUACION: PRESENTA RESTRICCION ''
        Case "PRESENTA RESTRICCION", "PRESENTA RESTRICCI"&Chr(211)&"N", "APTO CON LIMITACI"&Chr(211)&"N O RESTRICCI"&Chr(211)&"N QUE S"&Chr(205)&" INTERFIERE PARA EL CARGO"
            validateConcepts = Trim("PRESENTA RESTRICCION")
            
        '' CONCEPTO DE EVALUACION: APTO CON RECOMENDACION ''
        Case "APTO CON RECOMENDACION", "APTO CON RESTRICCION", "CON PATOLOGIA QUE NO LIMITA LA LABOR", _
        "APTO CON DEFECTO F"&Chr(205)&"SICO O PATOLOGIA QUE NO LIMITA SU LABOR", "REINTEGRO CON RECOMENDACIONES", _
        "REINTEGRO CON MODIFICACIONES/RESTRICCIONES", "PRESENTA RESTRICCIONES", "REINTEGRO CON RESTRICCIONES", _
        "REINTEGRO CON RECOMENDACIONES", "APTO CON RESTRICCIONES","APTO CON PATOLOG"&Chr(205)&"AS (QUE NO LIMITAN SU CAPACIDAD LABORAL)","APTO CON RECOMENDACIONES","EXAMEN PERIODICO CON RECOMENDACIONES"
