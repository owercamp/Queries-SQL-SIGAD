    ...
    For Each ItemData In opto_origin_value
      ...
      If (typeExams(charters(ItemData.Offset(, opto_origin_dictionary("TIPO EXAMEN")))) <> "EGRESO") Then
        With ActiveCell
          ...
          .Offset(, opto_destiny_dictionary("DIAG PPAL")) = charters(ItemData.Offset(, opto_origin_dictionary("DIAG PPAL")))
          .Offset(, opto_destiny_dictionary("DIAG OBS")) = charters(ItemData.Offset(, opto_origin_dictionary("DIAG OBS")))
          .Offset(, opto_destiny_dictionary("DIAG REL/1")) = charters(ItemData.Offset(, opto_origin_dictionary("DIAG REL/1")))
          .Offset(, opto_destiny_dictionary("DIAG REL/2")) = charters(ItemData.Offset(, opto_origin_dictionary("DIAG REL/2")))
          .Offset(, opto_destiny_dictionary("DIAG REL/3")) = charters(ItemData.Offset(, opto_origin_dictionary("DIAG REL/3")))
          ...
          .Offset(, opto_destiny_dictionary("RECOMENDACIONES OBS")) = charters(ItemData.Offset(, opto_origin_dictionary("RECOMENDACIONES OBS")))
          ...
          .Offset(, opto_destiny_dictionary("REMISIONES OBS")) = charters(ItemData.Offset(, opto_origin_dictionary("REMISIONES OBS")))
