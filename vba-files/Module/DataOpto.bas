    ...
    formImports.lblGeneral.Caption = "importando " & CStr(numbersGeneral) & " de " & CStr(totalData) & "(" & CStr(totalData - numbersGeneral) & ") REGISTROS"
      formImports.lblDescription.Caption = "importando " & CStr(numbers) & " de " & CStr(counts) & "(" & CStr(counts - numbers) & ") " & opto_destiny.Name
        ...
        If (typeExams(charters(ItemData.Offset(, opto_origin_dictionary("TIPO EXAMEN")))) <> "EGRESO") Then
          ...
          ActiveCell.Offset(, opto_destiny_dictionary("DIAG PPAL")) = charters(ReplaceNonAlphaNumeric(ItemData.Offset(, opto_origin_dictionary("DIAG PPAL"))))
          ActiveCell.Offset(, opto_destiny_dictionary("DIAG OBS")) = charters(ReplaceNonAlphaNumeric(ItemData.Offset(, opto_origin_dictionary("DIAG OBS"))))
          ActiveCell.Offset(, opto_destiny_dictionary("DIAG REL/1")) = charters(ReplaceNonAlphaNumeric(ItemData.Offset(, opto_origin_dictionary("DIAG REL/1"))))
          ActiveCell.Offset(, opto_destiny_dictionary("DIAG REL/2")) = charters(ReplaceNonAlphaNumeric(ItemData.Offset(, opto_origin_dictionary("DIAG REL/2"))))
          ActiveCell.Offset(, opto_destiny_dictionary("DIAG REL/3")) = charters(ReplaceNonAlphaNumeric(ItemData.Offset(, opto_origin_dictionary("DIAG REL/3"))))
          ...
          ActiveCell.Offset(, opto_destiny_dictionary("RECOMENDACIONES OBS")) = charters(ReplaceNonAlphaNumeric(ItemData.Offset(, opto_origin_dictionary("RECOMENDACIONES OBS"))))
          ...
          ActiveCell.Offset(, opto_destiny_dictionary("REMISIONES OBS")) = charters(ReplaceNonAlphaNumeric(ItemData.Offset(, opto_origin_dictionary("REMISIONES OBS"))))
