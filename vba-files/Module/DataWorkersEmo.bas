    ...
    For Each ItemData In emo_origin_value
      ...
      If (typeExams(charters(ItemData.Offset(, emo_origin_dictionary("TIPO EXAMEN")))) <> "EGRESO") Then
        With ActiveCell
          ...
          .Offset(, emo_destiny_dictionary("OBS DIAGS")) = charters(ItemData.Offset(, emo_origin_dictionary("OBS DIAGS")))
          .Offset(, emo_destiny_dictionary("CONCEPTO DE EVALUACION")) = validateConcepts(charters(ItemData.Offset(, emo_origin_dictionary("CONCEPTO DE EVALUACION"))))
          .Offset(, emo_destiny_dictionary("OBSERVACIONES DEL CONCEPTO")) = charters(ItemData.Offset(, emo_origin_dictionary("OBSERVACIONES DEL CONCEPTO")))
          .Offset(, emo_destiny_dictionary("RECOMENDACIONES ESPECIFICAS")) = charters(ItemData.Offset(, emo_origin_dictionary("RECOMENDACIONES ESPECIFICAS")))
