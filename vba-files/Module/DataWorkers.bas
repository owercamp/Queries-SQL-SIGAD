    ...
    For Each ItemData In workers_value
      ...
      If (typeExams(charters(ItemData.Offset(, emo_dictionary("TIPO EXAMEN")))) <> "EGRESO") Then
        ...
        With ActiveCell
          ...
          .Offset(, workers_dictionary("PACIENTE")) = charters(ItemData.Offset(, emo_dictionary("PACIENTE")))
          ...
          .Offset(, workers_dictionary("NRO HIJOS")) = charters(ItemData.Offset(, emo_dictionary("NRO HIJOS")))
          ...
          .Offset(, workers_dictionary("CARGO USUARIO")) = charters(ItemData.Offset(, emo_dictionary("CARGO USUARIO")))
          .Offset(, workers_dictionary("LAB DURACION EN ANOS")) = charters(ItemData.Offset(, emo_dictionary("LAB DURACION EN ANOS")))
