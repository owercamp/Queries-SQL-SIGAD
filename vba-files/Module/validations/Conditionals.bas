...
Public Sub internalDiagnosis(ByVal selection As Object)
  ...
  selection.FormatConditions.Add Type:=xlExpression, Formula1:= _
  "=Y($AZ4<>""AUDICION NORMAL BILATERAL"";$AZ4<>""DISMINUCION LEVE UNILATERAL / BILATERAL"";$AZ4<>""DISMINUCION MODERADA UNILATERAL / BILATERAL"";$AZ4<>""DISMINUCION MODERADA A SEVERA UNILATERAL / BILATERAL"";$AZ4<>""DISMINUCION SEVERA UNILATERAL / BILATERAL"";$AZ4<>""DISMINUCION PROFUNDA UNILATERAL / BILATERAL"";$AZ4<>""DISMINUCION LEVE BILATERAL"";$AZ4<>""DISMINUCION MODERADA A SEVERA BILATERAL"";$AZ4<>""DISMINUCION LEVE UNILATERAL"";$AZ4<>""DISMINUCION MODERADA BILATERAL"";$AZ4<>""DISMINUCION PROFUNDA BILATERAL"";$AZ4<>""DISMINUCION PROFUNDA UNILATERAL"";$AZ4<>""DISMINUCION MODERADA UNILATERAL"";$AZ4<>""DISMINUCION SEVERA BILATERAL"";$AZ4<>""DISMINUCION SEVERA UNILATERAL"";$AZ4<>""DISMINUCION MODERADA A SEVERA UNILATERAL"")"
  selection.FormatConditions(selection.FormatConditions.Count).SetFirstPriority
  With selection.FormatConditions(1).Font
    .Bold = True
    .Italic = False
